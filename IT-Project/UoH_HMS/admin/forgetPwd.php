...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../user/css/forgot_pwd_style.css">
...
if (isset($_POST['p_change'])) {
    ...
    $sql = "SELECT id, email FROM admin WHERE id='$id' and email='$email'";
    ...
    if ($count == 1) {
        ...
        $query = "UPDATE admin SET PASSWORD ='$pwdEncoded' WHERE id='$id'";
